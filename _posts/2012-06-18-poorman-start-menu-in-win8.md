...
Start Menu was introduced in Windows 95, it has been in use by many versions of Windows for many years. Now it’s gone
in Windows 8, at least in Release Preview.  As a keyboard guy, I am used to directly type the app name partially since
Vista, so it’s not a big deal to say bye bye to Start Menu.  But sometimes I do want to see the hierarchical list of 
